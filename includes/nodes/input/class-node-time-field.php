...
class FormFlow_Node_Time_Field extends FormFlow_Node {
    ...
    public function get_description() {
        return 'A standard time picker input.';
    }
    ...
    public function get_js_config() {
        return array(
            ...
            'fields'  => array(
                array( 'name' => 'label', 'label' => 'Field Label', 'type' => 'text', 'default' => 'Time Picker' ),
