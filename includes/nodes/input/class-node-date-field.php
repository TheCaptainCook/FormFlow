...
class FormFlow_Node_Date_Field extends FormFlow_Node {
    ...
    public function get_description() {
        return 'A standard date picker input.';
    }
    ...
    public function get_js_config() {
        return array(
            ...
            'fields'  => array(
                array( 'name' => 'label', 'label' => 'Field Label', 'type' => 'text', 'default' => 'Date Picker' ),
